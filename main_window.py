...
def register1():
    ...
    CheckBox=Checkbutton(object,text="Remember Information !!!!!",bg="silver",font="Arial 10 bold").place(x=600,y=500)
    Button(object,text="Submit",command=submit ,fg="GOLD",bg="BLACK",bd=5,font="arial 10 bold").place(x=600,y=550)
    Button(object,text="Clear",command=clear ,fg="GOLD",bg="BLACK",bd=5,font="arial 10 bold").place(x=750,y=550) 
